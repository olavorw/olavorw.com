...
export const metadata: Metadata = {
  ...
  authors: [
    {
      name: 'I\'m Olav "Olavorw" Sharma. I do cool nerdy stuff. In more detail, I\'m a full stack software developer, hardware enthusiast, entrepreneur, and founder of 4934 Tech.',
...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`dark ${geistSans.variable} ${azeretMono.variable}`}
    >
