    ...
    return (
      <>
            <UnifiedSection
                ...
                description={"Welcome to the copyright page for olavorw.com / Olav \"Olavorw\" Sharma (\"we,\" \"our,\" \"us,\" \"I\"). "}
                content={"Below, you will find information regarding the licensing and copyright details for my projects and website. I am " +
          ...
          <UnifiedSection
              ...
              topOfPage={false}
              centered={true}
              content={"Most of my projects are open source and distributed under the GNU General Public License 3 (GPLv3) or Apache License. 2.0" +
          ...
          <UnifiedSection
              title={"2. Attribution"}
              content={"Attribution is a core aspect of open-source software. When using or redistributing my projects, please include the following if applicable:\n"}
              topOfPage={false}
              centered={true}
              features={[
                  {
              ...
              additionalContent={"Please note that there are lots of exceptions to this, please see the section below."}
          />
          <UnifiedSection title={"3. Exceptions"}
                content={"As for attribution, while I encourage attribution, it is not explicitly required in the GNU General Public License (GPLv3) which I license" +
                ...
                centered={true}
          />
          <UnifiedSection title={"4. Use of Content"}
                content={"My projects, website and their contents are protected by copyright laws. You may not go further than the restrictions made clear in the respective project's" +
                ...
                centered={true}
          />
            <UnifiedSection title={"5. This website's License Information"}
                            description={"The following information applies to the content on this website, olavorw.com."}
              content={"My website, 4934.tech, and its content are fully open source and distributed under the Apache License. 2.0. You can find the full text of the license" +
                ...
                centered={true}
            />
          <UnifiedSection title={"6. Individual Project Licensing"}
                content={"Some projects may have different licensing terms. Please refer to the individual project repositories for the most accurate information on licensing and use.\n" +
                    "If I make documentation for a project, I usually provide more information about the licensing and use of the project."}
                topOfPage={false}
                centered={true}
            />
            <UnifiedSection title={"7. Contact Information"}
                    content={"If you have any questions or concerns regarding the licensing or use of my projects, please contact me using the form on my website or by emailing me at " +
            ...
            />
            <UnifiedSection title={"8. Changes to this Policy"}
                content={"I reserve the right to update or modify this policy at any time. Changes to this policy will be reflected on this page. Please review this page periodically for " +
