...
export default function EmailSignup({ showcase }: EmailSignupProps) {
  return (
    <div
      className={`relative ${showcase ? '' : 'overflow-hidden bg-transparent py-16 sm:py-24 lg:py-32'} isolate`}
    >
          ...
          <dl className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
            <div className="flex flex-col items-start">
              <div className="rounded-md bg-white/5 p-2 ring-1 ring-white/10">
                <Check aria-hidden="true" className="size-6 text-slate-300" />
              </div>
              <dt className="mt-4 text-base font-semibold text-white">
                Once in a while
              </dt>
              <dd className="mt-2 text-base/7 text-slate-400">
                We don&apos;t usually have stuff worthy of your inbox every day.
                We&apos;ll only send you the good stuff.
              </dd>
            </div>
            <div className="flex flex-col items-start">
              <div className="rounded-md bg-white/5 p-2 ring-1 ring-white/10">
                <X aria-hidden="true" className="size-6 text-slate-300" />
              </div>
              <dt className="mt-4 text-base font-semibold text-white">
                No spam, ever
              </dt>
              <dd className="mt-2 text-base/7 text-slate-400">
                We hate spam as much as you do. We promise to never spam you
