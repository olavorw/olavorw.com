        ...
        <AnimatePresence>
            {isVisible && (
                <motion.div
                    ...
                    initial={showCased ? { opacity: 0, y: 0 } : { opacity: 0, y: -50, x: '-50%' }}
                    animate={showCased ? { opacity: 1, y: 0 } : { opacity: 1, y: 0, x: '-50%' }}
                    exit={showCased ? { opacity: 0, y: 0 } : { opacity: 0, y: -50, x: '-50%' }}
                ...
                >
                    <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
                        ...
                        >
                            ...
                            {mainTitle && subtitle && <span className="mx-2 text-slate-300">·</span>}
                        ...
                        {buttonText && buttonHref && (
                            ...
                            >
                                ...
                                >
                                    {buttonText} <span aria-hidden="true" className="ml-1">→</span>
                                </Link>
                            </motion.div>
                        )}
                    </div>
