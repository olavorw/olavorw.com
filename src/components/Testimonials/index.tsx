...
export default function Testimonials() {
  const testimonials = [
    ...
    {
      quote:
        'Laborum quis quam. Dolorum et ut quod quia. Voluptas numquam delectus nihil. Aut enim doloremque et ipsum.',
    ...
    {
      quote:
        'Molestias ea eorum quos nostrum doloremque sed. Quaerat quasi aut velit incidunt excepturi rerum voluptatem minus harum.',
    ...
    {
      quote:
        'Architecto libero natus est. Est quam debitis officia enim atque ut non. Sunt reiciendis quasi eaque. Itaque error ut et.',
      author: 'Floyd Miles',
      handle: '@floydmiles',
      avatar: '/placeholder.svg?height=40&width=40',
    },
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden md:grid md:grid-cols-2 lg:hidden gap-6">
          {tabletTestimonials.map((testimonial, index) => (
            <div key={index} className={index === 1 ? 'md:col-span-2' : ''}>
              <blockquote className="bg-black/40 backdrop-blur-lg rounded-2xl shadow-sm p-6">
                <p className="text-slate-300 mb-4">
                  &quot;{testimonial.quote}&quot;
                </p>
        ...
        <div className="hidden lg:grid lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-8">
            {desktopTestimonials.slice(0, 3).map((testimonial, index) => (
              <blockquote
                key={index}
                className="bg-black/40 backdrop-blur-lg rounded-2xl shadow-sm p-6"
              >
                <p className="text-slate-300 mb-4">
                  &quot;{testimonial.quote}&quot;
                </p>
          ...
          <div className="col-span-2 space-y-8">
            {desktopTestimonials.slice(3, 6).map((testimonial, index) => (
              <blockquote
                key={index}
                className="bg-black/40 backdrop-blur-lg rounded-2xl shadow-sm p-14"
              >
